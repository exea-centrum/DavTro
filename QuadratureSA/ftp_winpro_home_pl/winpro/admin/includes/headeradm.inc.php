     ...
     <table width='768' border='0' cellspacing='4' align='center'>
      <tr valign='middle'>
       <td width='222' align='left'>
        <img src='../pictures/winpro.png' alt='Oknoplast' width='250' height='80' border='0' >
...
while ($rowH = mysql_fetch_assoc($resH)) {
    echo "<td ><div align='center' border='0'><a href=\"$SERVER[REQUEST_URI]?language=$rowH[sectionkey]\"]><img src=\"../pictures/flags/$rowH[c]\" width='16' height='11' title=\"$rowH[sectionkey]\" ></a></div></td>";
} //<img src=\"./pictures/flags/$rowH[c]\" width='16' height='11' title=\"$rowH[sectionkey]\" alt='polsky'>
unset($lnflag);
echo "  </tr>
