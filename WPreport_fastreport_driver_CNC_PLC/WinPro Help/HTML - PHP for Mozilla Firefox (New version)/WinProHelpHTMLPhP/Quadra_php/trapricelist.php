...
if(top.frames.length==0) { top.location.href="index.php?trapricelist.php"; }
else { parent.quicksync('a5.4.7'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        href="introduction.php">Top</a>  <a href="tralabour.php">Previous</a> 
        <a href="tradxf.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        lets you link one or more price table to each transom, depending on the
        colour.</span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center; margin: 14px 0px 0px 0px;"><img
        src="img/clip0170eng.jpg" width="591" height="403" border="0"
        alt="clip0170eng"></p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Min length</span>: The minimum length accepted for this frame.</p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Lengths</span>: List of the lengths in the price table. The gap between 2 dimensions may be variable.</p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Generate</span><span style="color: #000000;">: This button lets you fill 
		automatically the lengths list, with a constant increment.</p>
		...
		total dimensions, exact dimensions or masonry dimensions.</p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        de lier une grille de prix à chaque traverse, en fonction de sa
        couleur.</span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center;"><img src="img/clip0408.gif" width="497"
        height="367" border="0" alt="clip0408"></p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Longueur minimum</span><span
        class="f_Textestd">: Longueur minimum acceptée pour cette
        traverse.</span></p>
        ...
        class="f_Textestd">: Si la traverse peut être fabriqué dans plusieurs
        ...
        en côtes hors-tout ou suivant la dimension exacte.</span></p>
