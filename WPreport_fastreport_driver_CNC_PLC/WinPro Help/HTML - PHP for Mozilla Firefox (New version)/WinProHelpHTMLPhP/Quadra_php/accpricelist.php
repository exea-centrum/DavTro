...
if(top.frames.length==0) { top.location.href="index.php?accpricelist.php"; }
else { parent.quicksync('a5.7.8'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="accremoveddrawings.php">Previous</a>  <a
        href="accessoriesfilter.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        de lier une grille de prix à chaque accessoire, en fonction de sa
        couleur. </span></p>
        ...
        class="f_Textestd">: Largeur minimum acceptée pour cet accessoire.</span></p>
        ...
        class="f_Textestd">: Hauteur minimum acceptée pour cet accessoire.</span></p>
        ...
        class="f_Textestd">: Si l'accessoire peut être fabriqué dans
