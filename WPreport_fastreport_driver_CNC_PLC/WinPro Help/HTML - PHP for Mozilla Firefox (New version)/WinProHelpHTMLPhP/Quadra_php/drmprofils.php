  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        d'énumérer les profils qui peuvent entrer dans la composition du
        dormant, et de donner les règles d'utilisation de chacun de ces
        profils. </span></p>

        <p class="p_Textestd"><span class="f_Textestd">Les profils ainsi
        définis seront examinés un à un pour chaque côté du dormant, dans
        l'ordre de leur définition.</span></p>

        <p class="p_Textestd"><span class="f_Textestd">De plus, la première
        formule de profil est évaluée dans la phase de calcul dimensionnel.
        Vous pouvez donc y définir:</span></p>
        ...
        <p class="p_Textestd" style="margin: 0px 0px 0px 24px;">La pénétration
        de chaque bord de la menuiserie dans la maçonnerie (variables <span
