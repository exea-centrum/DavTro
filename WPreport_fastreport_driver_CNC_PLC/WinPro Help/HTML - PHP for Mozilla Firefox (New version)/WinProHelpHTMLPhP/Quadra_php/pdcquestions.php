...
if(top.frames.length==0) { top.location.href="index.php?pdcquestions.php"; }
else { parent.quicksync('a5.14.4'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="pdclabour.php">Previous</a>  <a
        href="pdcvariables.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
