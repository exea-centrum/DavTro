...
if(top.frames.length==0) { top.location.href="index.php?volcoulissevariables.php"; }
else { parent.quicksync('a6.3.5'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcoulissequestions.php">Previous</a>  <a
        href="volcoulisseprofils.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
...
<!-- Placeholder for topic body. -->
        ...
        variables to help you computing the roller shutter rail components. They are listed
        below. </span></p>
          ...
          <tbody>
            ...
            <tr valign="top" align="left">
              ...
              <td width="558"
                ...
                style="margin: 0px 0px 0px 13px;">Rail base dimension (beneath shutter box).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Outside height of the shutter box.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Shutter rail location, into values <span class="f_Variables">Left</span>,
				<span class="f_Variables">Right</span> or <span class="f_Variables">Center</span>in case of double rail.</p>
              </td>
            </tr>
...
<!-- Placeholder for topic body. -->
        ...
        composants de vos coulisses de volets roulants. En voici la liste.</p>
        ...
        style="background-color: #fff7ef; border: solid 3px #c0c0c0; border-spacing:0px; border-collapse: collapse;">
          <tbody>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="text-indent: 1px; margin: 0px 0px 0px 13px;">Dimension
                de la coulisse (hauteur sous caisson).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;"><span
                class="f_Comment">Hauteur extérieure du caisson.</span></p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;"><span
                class="f_Comment">Positionnement de la coulisse, </span><span
                class="f_Variables">Gauche</span><span class="f_Comment">,
                </span><span class="f_Variables">Droite</span><span
                class="f_Comment">ou </span><span
                class="f_Variables">Centre</span><span class="f_Comment">en cas
                de coulisse double.</span></p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                ...
                style="font-weight: bold;">Description</span> de la coulisse. </p>
