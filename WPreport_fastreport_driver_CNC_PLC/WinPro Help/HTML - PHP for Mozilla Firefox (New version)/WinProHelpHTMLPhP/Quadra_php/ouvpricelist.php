  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        de lier une grille de prix à chaque ouvrant, en fonction de sa
        couleur.</span></p>
        ...
        class="f_Textestd">: Largeur minimum acceptée pour cet
        ouvrant.</span></p>
        ...
        class="f_Textestd">: Hauteur minimum acceptée pour cet
        ouvrant.</span></p>
        ...
        class="f_Textestd">: Si l'ouvrant peut être fabriqué dans plusieurs
        ...
        grille de prix est définie, entre côtes fabrication, côtes tableau,
        fond de feuillure ouvrant, fond de feuillure dormant ou dimensions
        extérieur ouvrant.</span></p>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Grille de vitrage</span>:
                Vous pouvez associer une grille de prix à l'ouvrant afin de
                chiffrer le vitrage. Vous pouvez choisir de calculer cette
                grille pour affecter le prix de revient tarif ou courant. Vous
                pouvez aussi choisir le type de dimension de verre à
                considérer, entre la dimension hors tout (fond de battée
                dormant), dimension exacte (telle que calculée) ou dimension
                tableau (élargi à l'extérieur du dormant ou à l'axe
              traverse)</td>
            </tr>
          </tbody>
        </table>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Prix au m²</span>: Saisir
                ici un prix au mètre carré plutôt qu'une grille de prix. Ce
                prix utilisera les mêmes dimensions que les grilles de
              prix.</td>
            </tr>
          </tbody>
        </table>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Prix min</span>: Si le prix
                de vitrage est calculé par le champs de prix au mètre carré
                ci-dessus, vous pouvez définir ici un prix minimum (par
                vantail).</td>
            </tr>
          </tbody>
        </table>
