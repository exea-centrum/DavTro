...
if(top.frames.length==0) { top.location.href="index.php?pararticle.php"; }
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="parprofiles.php">Previous</a>  <a href="parlabour.php">Next</a>
        </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"></span>This page
        ...
        this glazing bead. You have to give the rules for using each article.
        The articles will be examined by WinPro in the order in which they are
        defined, for each side successively.</p>

        <p>This page is accessible only if you select to define the glazing bead by
        formulas within <a href="pardescription.php">Description page</a>.
		Articles will be computed in sequence.</p>

        <p style="text-align: center;"><img src="img/clip100eng.jpg" width="652"
        height="350" border="0" alt="clip100eng"></p>

        <p>The page is divided in 3 sections (left, center, right).</p>

        <p><span style="font-size: 5pt;"> </span></p>

        <p><span style="font-weight: bold;">The left section</span> contains the list of articles. Select a line in
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Do not use for cost price</span>: the price of the article will not be used when computing the cost price. </td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Do not use for selling price</span>: the price of the article will not be used when computing the selling price. </td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Simpl. fact. document</span>: the article will be listed on simplified factory documents.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Customer documents</span><span style="color: #000000;">: the article
                will be mentioned (with quantity and dimension) on customer documents (quotation, confirmation, delivery).</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Print price on cust. doc.</span><span style="color: #000000;">: if
                the article is mentioned on customer document, this check box tells WinPro its selling price must also be detailed.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Delivery preparation</span><span style="color: #000000;">: the article
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Quality control</span>: the article will be listed on quality control documents.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        <p><span style="font-weight: bold;">The central section</span> contains the list of
        colours defined as standard and standard-RAL colours in the system to which the glass bead belongs. If the article has no colour rule to
        follow, you simply need to select nothing from this list. If the article (and its formula) only apply for specific colours, you must
        ...
        <p>Below this colour list is a few extra check boxes:</p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Standard</span>: When this box is checked, the article can be used with any of the standard colours.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">RAL 1 colour</span><span style="color: #000000;">: When this box is
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">RAL 2 colours</span><span style="color: #000000;">: When this box is
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">No colour</span>: Check this box if the article colour is undefined (e.g. screw).</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Glass joint</span>: Check this box if
                the formula applies to the joint on the main profile. This is used only for cross-sections.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Glazing bead joint</span>: Check this box
                if the formula applies to the joint on the glazing bead. This is used only for cross-sections.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Outer frame</span><span style="color: #000000;">: Check this box if
                the formula can apply to a glazing bead in the outer frame (fixed sash).</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Sash</span>: Check this box if the formula can
                apply to a glazing bead in the sash (not fixed sash).</td>
            </tr>
          </tbody>
        </table>
        </div>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"></span>Cet onglet
        permet de définir les articles à consommer pour ce cadre de parcloses,
        et n'est accessible que si la case Paramétrage par formule est cochée
        dans la <a href="pardescription.php">page Description</a>.</p>
        ...
        <p style="text-align: center;"><img src="img/clip100fra.jpg" width="657"
        height="348" border="0" alt="clip100fra"></p>
        ...
        liste des articles à consommer pour ce cadre parclose. Sélectionner une
        ...
        liste des couleurs autorisées pour le système auquel la parclose appartient. Si l'article n'est pas
        dépendant de la couleur, il suffit de ne rien sélectionner dans cette liste. Si l'article (et sa formule) s'applique uniquement pour
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Joint vitrage</span>: Cocher
                cette case si la formule s'applique pour le joint sur le profil
                principal. Utilisé seulement dans les vues en coupe.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Joint de parclose</span>:
                Cocher cette case si la formule s'applique pour le joint sur le
                profil de parclose. Utilisé seulement dans les vues en
              coupe</td>
            </tr>
          </tbody>
        </table>
