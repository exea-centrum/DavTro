...
if(top.frames.length==0) { top.location.href="index.php?drmmainoeuvre.php"; }
else { parent.quicksync('a5.2.9'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="drmpièceangle.php">Previous</a>  <a
        href="drmmainoeuvreangle.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        <p style="text-align: center; margin: 14px 0px 14px 0px;"><img src="img/clip0135eng.jpg" width="609" height="375" border="0" alt="clip0135eng"></p>
        ...
        which the outer frame belongs to. If the operation has no colour rule to
        ...
        section</span> contains the formula that applies to the operation, as well as some check boxes:</span></p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
			  ...
			  : The formula will be applied for selected sides.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd" style="font-weight: bold;">Window</span>: If checked, tells that the formula
                can apply to frames not containing a door.</td>
            </tr>
          </tbody>
        </table>
        </div>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        d'énumérer les opérations relatives à chaque côté du dormant, et de
        ...
        <p style="text-align: center;"><img src="img/clip0135.jpg" width="594"
        height="355" border="0" alt="clip0135"></p>
        ...
        class="f_Textestd"> contient la liste des opérations; sélectionnez une
        ligne de cette liste, et indiquez le code de l'opération dans la zone
        de saisie immédiatement au-dessus de la liste.</span></p>
