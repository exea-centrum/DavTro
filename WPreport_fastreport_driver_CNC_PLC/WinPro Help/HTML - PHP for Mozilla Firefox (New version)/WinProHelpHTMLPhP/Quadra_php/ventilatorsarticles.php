...
if(top.frames.length==0) { top.location.href="index.php?ventilatorsarticles.php"; }
else { parent.quicksync('a5.13.5'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="ventilatorsprofiles.php">Previous</a>  <a
        href="ventilatorslabour.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p>This page allows you enumerating all the articles that can be used to create this ventilator.</p>
        ...
        src="img/clip0531eng.jpg" width="532" height="295" border="0"
        alt="clip0531eng"></p>
        ...
        style="font-weight: bold; text-decoration: underline;">The left section</span> contains the list of articles. 
		Select a line in
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd" style="font-weight: bold;">Customer
                documents</span>: the component will be mentioned (with quantity and dimension) 
				onto customer documents (quotation, confirmation, delivery).</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd"
                style="font-weight: bold;">RAL 1 colour</span>: When this box is checked, the article can be used 
				with any of the non-standard RAL single-colour.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">RAL 2 colours</span>: When this box is checked, the article can be used 
				with any of the non-standard RAL bi-colour.</td>
            </tr>
          </tbody>
        </table>
        </div>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p>Cet onglet permet de définir les articles à consommer
        ...
        <p style="text-align: center;"><img src="img/clip0531fra.jpg"
        width="532" height="297" border="0" alt="clip0531fra"></p>
        ...
        liste des articles à consommer pour cet aérateur. Sélectionner
