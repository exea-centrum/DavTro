...
if(top.frames.length==0) { top.location.href="index.php?pfabvariables.php"; }
else { parent.quicksync('a5.11.3'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="pfabquestions.php">Previous</a>  <a
        href="pfabvitrages.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        <p>WinPro generates several variables to help you compute the composed panel
          ...
          <tbody>
            <tr valign="top" align="left">
              <td width="605"
                ...
                <p style="margin: 0px 0px 0px 40px;"><span
                style="font-weight: bold;">N</span> = Plain panels</p>
          ...
          <tbody>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-size: 13pt; font-family: 'Wingdings'; font-weight: bold; color: #ff0000;">&lArr;</span><span
                style="font-weight: bold;">GNPAL</span></p>
              </td>
              <td width="367" style="width: 367px; border: solid 1px #c0c0c0;">
                <div
                style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td><span style="font-weight: bold;">Profiles:</span> Number of
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td><span style="font-weight: bold;">Glazings:</span> Number of
                        identical glass unit to cut. This must be an integer
                        number.</td>
                    </tr>
                  </tbody>
                </table>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td><span style="font-weight: bold;">Panels:</span> Number of
                        identical panel unit to cut. This must be an integer
                        number.</td>
                    </tr>
                  </tbody>
                </table>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td><span style="font-weight: bold;">Labour:</span> Length of the operation, into
                        seconds. You can also use a time notation (hour:minutes:seconds or minutes:seconds - see the
                        section about <a href="nombres.php">numbers</a>). Fractional seconds are allowed.
					   </td>
                    </tr>
                  </tbody>
                </table>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
					  ...
					  <a href="pfabdescription.php">Description page</a>; you may modify this value into any formula (except drawing formulas).
					   </td>
                    </tr>
                  </tbody>
                </table>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Thickness of the current glass unit.
					   </td>
                    </tr>
                  </tbody>
                </table>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Type of sash containing the glass: 
					  <span class="f_Variables">Door</span>, <span class="f_Variables">Fixed</span> or <span class="f_Variables">Window</span>.
					   </td>
                    </tr>
                  </tbody>
                </table>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>You may create this variable to force an arched shape for the profile, or force its radius.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Left angle of the profile. Contains 90° by default.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Right angle of the profile. Contains 90° by default.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-size: 13pt; font-family: 'Wingdings'; font-weight: bold; color: #ff0000;">&hArr;</span><span
                style="font-weight: bold;">GN</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Shape of the filling. This variable
                originally contains the shape of the filling, as computed by
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">GNPALDF</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Width of the composed panel (as defined
                in the <a href="pfabdescription.php">description
                page</a>).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Height of the composed panel (as defined
                in the <a href="pfabdescription.php">description
                page</a>).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">InteriorWidth</span></p>
              </td>
              <td valign="middle" width="68"
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Width of the composed panel (rebate
                dimension).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">InteriorHeight</span></p>
              </td>
              <td valign="middle" width="68"
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Height of the composed panel (rebate
                dimension).</p>
              </td>
            </tr>
           ...
           <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Width of the composed panel, extended
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Height of the composed panel, extended
                to the outside of the outer frame or the axis of the first
                transom.</p>
              </td>
            </tr>
           ...
           <tr valign="top" align="left">
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">GNPALF</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                ...
                filling (1 = leftmost or bottommost leaf).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                ...
                contains the filling (<span class="f_Variables">Left</span> or <span class="f_Variables">Right</span>).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">GNPA</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
        ...
        <p>When computing fillings components, you may use shape handling functions
        ...
        shape information on the original filling dimensions; index 2 on outer
          ...
          <tbody>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
				...
				<span style="font-weight: bold;">GN</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        composants de vos panneaux fabriqués. En voici la liste.</p>
          ...
          <tbody>
            <tr valign="top" align="left">
              <td width="605"
               ...
               <p style="margin: 0px 0px 0px 40px;"><span
                style="font-weight: bold;">V</span> = Vitrages</p>
				
				<p style="margin: 0px 0px 0px 40px;"><span
                style="font-weight: bold;">N</span> = paNneau à découper</p>
               ...
               <p style="margin: 0px 0px 0px 40px;"><span
                style="font-weight: bold;">F</span> = formule de déFinition
                de dessin</p>
          ...
          <tbody>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-size: 13pt; font-family: 'Wingdings'; font-weight: bold; color: #ff0000;">&lArr;</span><span
                style="font-weight: bold;">VNPAM</span></p>
              </td>
              <td width="367" style="width: 367px; border: solid 1px #c0c0c0;">
                <div
                style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td><span style="font-weight: bold;">Panneaux:
                        </span>Nombre de panneaux identiques à consommer, au
                        format nombre entier naturel.
					   </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody>
                    <tr valign="baseline">
                      ...
                      <td><span style="font-weight: bold;">Main d'oeuvre:</span> Longueur de l'opération, en secondes.
                        ...
                        fractionnelles sont autorisées.
					   </td>
                    </tr>
                  </tbody>
                </table>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
					  ...
					  Contient initialement la valeur du champs Epaisseur de la page <a href="pfabdescription.php">Description</a>.
					   </td>
                    </tr>
                  </tbody>
                </table>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Epaisseur du vitrage courant.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Type d'ouvrant contenant le panneau: <span class="f_Variables">Porte</span>, 
					  <span class="f_Variables">Fixe</span>, <span class="f_Variables">Chassis</span>.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Renseigner cette variable pour imposer une forme cintrée sur un bord haut, ou pour modifier le rayon existant.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Angle de coupe gauche du profil, 90° par défaut.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
           ...
           <tr valign="top" align="left">
                ...
                style="line-height: normal;">
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #c0c0c0;">&bull;</span></td>
                      <td>Angle de coupe droite du profil, 90° par défaut.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-size: 13pt; font-family: 'Wingdings'; font-weight: bold; color: #ff0000;">&hArr;</span><span
                style="font-weight: bold;">VN</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Forme du remplissage. Cette
                ...
                class="f_Variables">DimA</span>, <span class="f_Variables">DimB</span>, ..., <span class="f_Variables">Orientation</span>, 
				en fonction de la nouvelle forme. Vous pouvez également utiliser les <a href="manipulation_de_formes.php">fonctions 
				de manipulation de formes</a> pour recalculer une nouvelle forme. Les valeurs possibles sont:</p>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                ...
                Voir la page concernant les <a href="manipulation_de_formes.php">fonctions de manipulation de
                formes</a> pour les références des dimensions concernées pour chaque forme.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">VNPAMDF</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Largeur du panneau fabriqué
                (telle que définie dans la <a href="pfabdescription.php">page
                description</a>).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Hauteur du panneau fabriqué
                (telle que définie dans la <a href="pfabdescription.php">page
                description</a>).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">LargeurInterieure</span></p>
              </td>
              <td valign="middle" width="68"
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">HauteurInterieure</span></p>
              </td>
              <td valign="middle" width="68"
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">VNPAMF</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                ...
                panneau (1 = le plus en bas à gauche).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">VNPAMD</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Sens de l'ouvrant contenant
                le panneau (<span class="f_Variables">Gauche</span> ou <span
                class="f_Variables">Droite</span>).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Opposé du sens de l'ouvrant contenant
                le panneau (<span class="f_Variables">Gauche</span> ou <span
                class="f_Variables">Droite</span>).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">VNPA</span></p>
              </td>
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                ...
                style="font-weight: bold;">Description</span> du panneau. </p>

                <p style="margin: 0px 0px 0px 14px;">Elle doit être paramétrée
                dans la première page vitrage du panneau impérativement, et
        ...
        <p>Lors du calcul des composants du remplissage, vous pouvez utiliser les
        ...
        dimension de remplissage originelle; l'élément d'index 2 pour la dimension
        hors tout du remplissage; l'index 3 pour la dimension tableau.</p>
