...
if(top.frames.length==0) { top.location.href="index.php?volcaissonarticles.php"; }
else { parent.quicksync('a6.1.7'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcaissonprofils.php">Previous</a>  <a
        href="volcaissonmo.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        this shutter box. You have to give the rules for using each article. The
        ...
        src="img/clip0544eng.jpg" width="718" height="375" border="0"
        alt="clip0544eng"></p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd" style="font-weight: bold;">Quality control</span>: the article will be listed onto
			  quality control documents.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        section</span> contains the list of colours allowed for this shutter box.</p>

        <p class="p_Textestd"><span class="f_Textestd">If the
        article has no colour rule to follow, you simply need to select nothing
        from this list. If the article (and its formula) only applies for
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd"
                ...
                can be used with any of the standard colours.</span></p>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        section</span> contains the formula that applies to the article, as
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Shutter box</span>:
                Check this box for the rule to be computed once for the whole box.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Box separators</span>:
                Check this box for the rule to be computed once by curtain minus one for this box.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Curtain (final blade colour)</span>:
                Check this box for the rule to be computed once by curtain minus one for this box.</td>
            </tr>
          </tbody>
        </table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"></span>Cet onglet
        permet de définir les articles à consommer pour ce caisson.</p>
        ...
        <p style="text-align: center;"><img src="img/clip0544fra.jpg"
        width="758" height="350" border="0" alt="clip0544fra"></p>
        ...
        liste des articles à consommer pour ce caisson. Sélectionner une
        ...
        liste des couleurs autorisées pour ce caisson. Si
        l'article n'est pas dépendant d'une couleur, il suffit de ne rien
        sélectionner dans cette liste. Si l'article (et sa formule) s'applique
        ...
        l'article, ainsi que différentes cases à cocher:</span></p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Caisson extérieur</span>:
                Cochez cette case pour que la formule soit évaluée une fois
                seulement pour tout le caisson.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Flasque intérieur</span>:
                Cochez cette case pour que la formule soit évaluée autant de
                fois moins une qu'il y a de tabliers pour ce caisson.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Tablier (Couleur
                Sous-Lame)</span>: Cochez cette case pour que la formule soit
                évaluée autant de fois qu'il y a de tabliers pour ce
              caisson.</td>
            </tr>
          </tbody>
        </table>
