...
if(top.frames.length==0) { top.location.href="index.php?volcoulissetarif.php"; }
else { parent.quicksync('a6.3.9'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcoulissemo.php">Previous</a>  <a
        href="volcoulissefiltres.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        lets you link one or more price table to each shutter rail, depending on the
        colour.</span></p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        de lier une grille de prix à chaque coulisse, en fonction de sa couleur.
        </span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center;"><img src="img/clip0553.zoom87.gif"
        width="589" height="370" border="0" alt="clip0553"></p>
        ...
        class="f_Textestd">: Si la coulisse peut être fabriquée dans plusieurs
        ...
        en côtes hors-tout, en dimensions exactes ou en côtes
        tableau.</span></p>
