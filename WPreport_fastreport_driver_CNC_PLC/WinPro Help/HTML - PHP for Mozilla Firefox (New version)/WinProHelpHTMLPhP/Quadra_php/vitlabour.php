...
if(top.frames.length==0) { top.location.href="index.php?vitlabour.php"; }
else { parent.quicksync('a5.8.11'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="vitarticles.php">Previous</a>  <a href="vitdrawings.php">Next</a>
        </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p>This page is accessible only if the box <span style="font-weight: bold">Composed glazing</span> is checked into the 
        ...
        this glazing. You have to give the rules for using each operation. 
		Vous devez renseigner une règle de consommation pour chaque main
        d'oeuvre.</p>

        <p>The operations will be examined by WinPro in the order in which they are
        defined.</p>

        <p> </p>

        <p style="text-align: center; margin: 14px 0px 14px 0px;"><img
        src="img/clip0193eng.jpg" width="627" height="349" border="0"
        alt="clip0193eng"></p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Do not use for cost price</span>: the
                price of the labour will not be used when computing the cost price.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="25"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Do not use for selling price</span>: the
                price of the labour will not be used when computing the selling price.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Simpl. fact. document</span>: the labour
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Customer documents</span>: the labour will
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Valued</span>: if the labour is mentioned onto customer document, this check box
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Delivery preparation</span>: the labour
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Quality control</span>: the labour will
        ...
        section</span> contains the list of colours allowed into the <a href="vitdescription.php">Description</a> page. 
		If the operation has no colour rule to follow, you simply need to select
        nothing from this list. If the operation (and its formula) only apply
        for specific colours, you must select each colour as appropriate.</p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Standard</span>: When this box is checked, the
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">RAL 1 colour</span>: When this box is
                checked, the operation can be used with any of the non-standard RAL single-colour.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">RAL 2 colours</span>: When this box is
                checked, the operation can be used with any of the non-standard RAL bi-colour.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        section</span> contains the operation's formula.</p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p>Cet onglet permet de définir les temps de main
        d'oeuvre à consommer pour ce vitrage composé, et n'est accessible que
        si la case <span style="font-weight: bold;">Vitrage composé </span>est
        cochée dans la <a href="vitdescription.php">page Description</a>.</p>
        ...
        liste des main d'oeuvres à consommer pour ce vitrage composé.
        Sélectionner une ligne dans cette liste, et saisissez le code de main
        d'oeuvre dans le champ de saisie immédiatement au-dessus de la
        liste.</p>
        ...
        liste des couleurs autorisées pour ce vitrage dans l'onglet <a
        href="vitdescription.php">Description</a>. Si la main d'oeuvre n'est
        pas dépendante de la couleur, il suffit de ne rien sélectionner dans
        cette liste. Si la main d'oeuvre (et sa formule) s'applique uniquement
        pour certaines couleurs, sélectionnez ces couleurs dans la liste.</p>
