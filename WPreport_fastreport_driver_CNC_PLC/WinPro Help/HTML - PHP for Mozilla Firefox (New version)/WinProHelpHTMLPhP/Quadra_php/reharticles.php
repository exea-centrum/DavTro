...
if(top.frames.length==0) { top.location.href="index.php?reharticles.php"; }
else { parent.quicksync('a5.5.5'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="rehprofiles.php">Previous</a>  <a href="rehlabour.php">Next</a>
        </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p>This page allows you to enumerate all the articles that can be used to create this peripheral profile (or sill).</p>
        ...
        <p style="text-align: center;"><img src="img/clip0250eng.jpg" width="634" height="360" border="0" alt="clip0250eng"></p>
        ...
        peripheral profile or sill belongs to.</span></p>

        <p class="p_Textestd"><span class="f_Textestd">When an article does not
        obey to any rule concerning colours, do no select anything here; when
        the article and its formula is depending on colour rules defined below,
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        rehausses et seuils, et de donner les règles
        d'utilisation de chacun de ces articles. Les articles ainsi définis
        seront examinés un à un pour chaque rehausse, dans l'ordre de leur
        définition.</span>.</p>
