...
if(top.frames.length==0) { top.location.href="index.php?drmmainoeuvreangle.php"; }
else { parent.quicksync('a5.2.10'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="drmmainoeuvre.php">Previous</a>  <a href="drmtarif.php">Next</a>
        </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        src="img/clip0136eng.jpg" width="609" height="375" border="0"
        alt="clip0136eng"></p>
        ...
        which the outer frame belongs. If the operation has no colour rule to
		...
		applies to the operation, as well as some check boxes:</p>
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Door</span>: If checked, tells that the formula can apply to frames containing a door.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Window</span>: If checked, tells that the formula can apply to frames not containing a door.</td>
            </tr>
          </tbody>
        </table>
        </div>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        d'énumérer les opérations relatives à chaque coin du dormant, et de
        donner les règles de calcul de chacune de ces opérations. Les
        opérations ainsi définies seront examinées une à une pour chaque coin
        du dormant, dans l'ordre de leur définition.</span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p class="p_Textestd" style="text-align: center;"><img
        src="img/clip0136.jpg" width="595" height="355" border="0"
        alt="clip0136"></p>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd" style="font-weight: bold;">Documents
                ...
                mentionnée (avec quantité et dimension) sur les documents
        ...
        système auquel appartient le dormant. </span></p>
        ...
        class="f_Textestd"> contient la formule liée à l'opération, ainsi que
