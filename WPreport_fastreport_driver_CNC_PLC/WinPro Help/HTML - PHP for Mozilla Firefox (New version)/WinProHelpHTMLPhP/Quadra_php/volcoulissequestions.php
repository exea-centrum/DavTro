...
if(top.frames.length==0)  { top.location.href="index.php?volcoulissequestions.php"; }
else { parent.quicksync('a6.3.4'); }
//-->
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#FF8000">
  <tr valign="middle">
    ...
    <td align="right">
     ...
     <a href="volcoulissecorrcouleur.php">Previous</a>&nbsp;
     <a href="volcoulissevariables.php">Next</a>
     </span>
    </td>
  </tr>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p> </p>
        ...
        <p>This page lets you define the questions for this roller shutter rail. See
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p> </p>
        ...
        <p>Cet onglet définit les questions pour cette coulisse de volet roulant. Reportez-vous à
