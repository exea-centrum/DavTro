...
<table width="100%" border="0" cellspacing="0" cellpadding="5"><tr valign="top"><td align="left">
<p>&nbsp;</p>
<p>Renvoie le jour du mois de la date passée en paramètre.</p>
<p class="p_Interligne"><span class="f_Interligne">&nbsp;</span></p>
...
<p style="margin: 0px 0px 0px 48px;"><span class="f_Variables"># j représente maintenant le jour du mois de la date de calcul</span></p>
