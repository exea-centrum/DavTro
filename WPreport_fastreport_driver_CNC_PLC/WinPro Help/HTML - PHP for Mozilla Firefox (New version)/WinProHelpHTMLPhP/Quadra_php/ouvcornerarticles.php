<?php Session_Start(); if (!isset($_SESSION['validate'])) { ; } ?>
<html>
<head>
...
var WinProHelpPageName=["Corner Article","Pi&#232;ce d'Angle"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?ouvcornerarticles.php"; }
else { parent.quicksync('a5.3.6'); }
//--></script>
  <script type="text/javascript" src="highlight.js">
  </script>
  <title>Pièce angle</title>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="ouvbasearticles.php">Previous</a>  <a
        href="ouvbaselabour.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        this sash. You have to give the rules for using each article. The
        articles will be examined by WinPro in the order in which they are
        defined, for each corner of each leaf successively.</span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center;"><img src="img/clip0388eng.jpg" width="484"
        height="333" border="0" alt="clip0388eng"></p>
        ...
        which the sash frame belongs. If the article has no colour rule to
        ...
        section</span> contains the formula that applies to the article, as well as a check box:</p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        coins de l'ouvrant, et de donner les règles d'utilisation de chacun de
        ces articles. Les articles ainsi définis seront examinés un à un pour
        chaque coin de chaque vantail successivement, dans l'ordre de leur
        définition. </span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center;"><img src="img/clip0388fra.jpg" width="496"
        height="294" border="0" alt="clip0388fra.jpg"></p>
        ...
        l'article, ainsi qu'une case à cocher:</span></p>
