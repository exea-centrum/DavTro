...
if(top.frames.length==0) { top.location.href="index.php?vitdrawings.php"; }
else { parent.quicksync('a5.8.12'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        href="introduction.php">Top</a>  <a href="vitlabour.php">Previous</a> 
        <a href="vitdxf.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        this glazing, and is only available when box <span style="font-weight: bold;">Composed glazing</span> is checked 
		into <a href="vitdescription.php">Description page</a>.</p>

        <p>You have to give the rules for positioning and scaling each drawing.</p>

        <p>The drawings will be examined by WinPro in the order in which they are defined.</p>
          ...
          <tbody>
            <tr valign="top" align="left">
              <td width="605"
                ...
                style="font-weight: bold;">Important</span>: If a drawing must not be drawn for any reason, use 
				a <span class="f_Variables">Fail</span> instruction, with no message.</p>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <p style="text-align: center;"><img src="img/clip0194eng.jpg"
        width="627" height="348" border="0" alt="clip0194eng"></p>
        ...
        style="font-weight: bold; text-decoration: underline;">The left section</span> contains the list of drawings to be used for this composed glazing.
        ...
        section</span> contains the list of colours allowed into the <a
        href="vitdescription.php">Description</a> page. If the
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Standard</span>: When this box is checked, the drawing
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">RAL 2 colours</span>: When this box is
                checked, the drawing can be used with any of the non-standard RAL bi-colour.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Visible from inside</span>: Check this
                box if the drawing is visible from inside the building.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Visible from outside</span>: Check this
                box if the drawing is visible from outside the building.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold; text-decoration: underline;">The right section</span> contains the drawing's
        positioning and scaling formula.</p>
      </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        <p>Cet onglet permet de définir les dessins à utiliser pour dessiner ce
        ...
        liste des dessins à utiliser pour ce vitrage composé. Sélectionner une
        ...
        href="vitdescription.php">Description</a>. Si le dessin n'est pas
        dépendant de la couleur, il suffit de ne rien sélectionner dans cette
        liste. Si le dessin (et sa formule) s'applique uniquement pour
