...
<table width="100%" border="0" cellspacing="0" cellpadding="5"><tr valign="top"><td align="left">
<p>&nbsp;</p>
<p>Traçage d'un arc de cercle ou d'ellipse, avec en plus une droite reliant les deux extrémités de l'arc. L'intérieur de l'arc est rempli au moyen de la brosse précédemment sélectionnée; le contour dépend du trait qui a été défini.</p>
<p style="margin: 0px 0px 0px 27px;"><span style="font-size: 5pt;">&nbsp;</span></p>
<p><span style="text-decoration: underline;">Syntaxe:</span></p>
<p><span class="f_Variables" style="font-weight: bold;">Corde (X, Y, rayon[, rayon vertical], angle début, angle fin)</span></p>
<p style="margin: 0px 0px 0px 27px;"><span style="font-size: 5pt;">&nbsp;</span></p>
...
<td width="454" style="width: 454px; border: solid 1px #c0c0c0;"><p> Rayon vertical de l'ellipse. Ce paramètre est optionnel; s'il est spécifié, l'arc est un arc d'ellipse; sinon c'est un arc de cercle</p>
</td>
</tr>
<tr valign="middle" align="left">
...
<td width="454" style="width: 454px; border: solid 1px #c0c0c0;"><p> Angle de début de l'arc de cercle, exprimé en degrés. L'angle 0 se trouve à gauche du cercle. Les angles croissent dans le sens inverse des aiguilles d'une montre. L'angle 90 se trouve donc en haut du cercle.</p>
</td>
</tr>
<tr valign="middle" align="left">
