...
if(top.frames.length==0) { top.location.href="index.php?quipricelist.php"; }
else { parent.quicksync('a5.6.9'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        href="introduction.php">Top</a>  <a href="quidrawing.php">Previous</a> 
        <a href="fittingsfilter.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        <p style="text-align: center; margin: 14px 0px 0px 0px;"><img src="img/clip0163eng.jpg" width="700"
        height="396" border="0" alt="clip0163eng"></span></p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        de lier une grille de prix à chaque quincaillerie, en fonction de sa
        couleur. </span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center;"><img src="img/clip0402.gif" width="580"
        height="372" border="0" alt="clip0402"></p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Largeur minimum</span><span
        class="f_Textestd">: Largeur minimum acceptée pour cette
        quincaillerie.</span></p>
        ...
        class="f_Textestd">: Hauteur minimum acceptée pour cette
        quincaillerie.</span></p>
        ...
        class="f_Textestd">: Si la quincaillerie peut être fabriqué dans
        plusieurs couleurs, vous aurez plusieurs grilles de prix à définir,
        chaque grille de prix étant liée à une ou plusieurs couleurs. Attribuez
        un numéro arbitraire à chaque grille de prix (de 0 à 99), et indiquez,
        pour chaque couleur, le numéro de le grille de prix
        ...
        en côtes hors-tout, fond de feuillure ouvrant, extérieur ouvrant, fond
        de feuillure dormant, ou en dimensions tableau.</span></p>
