  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span class="f_Textestd">Cet
        onglet vous permet de lier une grille de prix à chaque aérateur, en
        ...
        liste des Hauteurs définissant les colonnes de la grille de prix.
        ...
        class="f_Textestd">: Si l'aérateur peut être fabriqué dans plusieurs
        ...
        chaque couleur, le numéro de la grille de prix
        ...
        en côtes hors-toutn fond de feuillure ouvrant ou selon les côtes tableau.</span></p>
