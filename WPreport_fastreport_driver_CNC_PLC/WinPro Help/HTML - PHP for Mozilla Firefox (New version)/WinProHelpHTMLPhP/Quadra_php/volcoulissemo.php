...
if(top.frames.length==0) { top.location.href="index.php?volcoulissemo.php"; }
else { parent.quicksync('a6.3.8'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcoulissearticles.php">Previous</a>  <a
        href="volcoulissetarif.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p> </p>
        ...
        src="img/clip0558eng.jpg" width="496" height="326" border="0"
        alt="clip0558eng"></p>
        ...
        section</span> contains the list of colours allowed for this rail. If the
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p> </p>
        ...
        <p style="text-align: center;"><img src="img/clip0558.zoom91.gif"
        width="536" height="327" border="0" alt="clip0558"></p>
        ...
        liste des main d'oeuvres à consommer pour cette coulisse. Sélectionner
        ...
        liste des couleurs autorisées pour cette coulisse. Si la
        ...
        droite</span> contient la formule liée à la main d'oeuvre.</p>
