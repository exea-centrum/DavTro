...
if(top.frames.length==0) { top.location.href="index.php?pfabdrawings.php"; }
else { parent.quicksync('a5.11.9'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        href="introduction.php">Top</a>  <a href="pfablabour.php">Previous</a> 
        <a href="pfabpricelist.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        drawing has no colour rule to follow, you simply need to select nothing from this list. If the drawing (and its formula) only applies for
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        liste des dessins à utiliser pour ce panneau fabriqué. Sélectionner une
        ...
        href="pfabdescription.php">Description</a>. Si le dessin n'est pas
