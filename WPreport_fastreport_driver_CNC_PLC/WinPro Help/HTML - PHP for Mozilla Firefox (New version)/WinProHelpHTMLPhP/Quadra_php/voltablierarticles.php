...
if(top.frames.length==0) { top.location.href="index.php?voltablierarticles.php"; }
else { parent.quicksync('a6.2.9'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="voltablierprofils.php">Previous</a>  <a
        href="voltabliermo.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        this shutter curtain. You have to give the rules for using each article. The
        ...
        src="img/clip0551eng.jpg" width="563" height="392" border="0"
        alt="clip0551eng"></p>
        ...
        section</span> contains the list of colours allowed for this shutter curtain.</p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"></span>Cet onglet
        permet de définir les articles à consommer pour ce tablier.</p>
        ...
        <p style="text-align: center;"><img src="img/clip0551fra.jpg"
        width="560" height="341" border="0" alt="clip0551fra"></p>
        ...
        liste des couleurs autorisées pour ce tablier. Si
