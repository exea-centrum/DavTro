...
var WinProHelpPageName=["BowCutDefineTmpEnd","DecArcDefinirFin","BowCutDefineTmpEnd"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?decarcdefinirfin.php"; }
else { parent.quicksync('a2.4.5.2.2.3'); }
//-->
</script>
<script type="text/javascript" src="highlight.js"></script>

<title>DecArcDefinirFin</title>
<meta name="generator" content="Help &amp; Manual" />
<meta name="keywords" content="DecArcDefinirFin" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#FF8000">
  <tr valign="middle">
    ...
    <td align="right">
     ...
     <a href="decarcdefinirdebut.php">Previous</a>&nbsp;
     <a href="decarcajouterarc.php">Next</a>
     </span>
    </td>
  </tr>
</table>
...
<p>&nbsp;</p>
<p>This optional function gives to WinPro the angle value corresponding to the end of the bow. </p>
<p>The function always returns <span class="f_Variables">1</span>.</p>
<p class="p_Interligne"><span class="f_Interligne">&nbsp;</span></p>
<p style="margin: 0px 0px 0px 24px;"><span style="text-decoration: underline;">Syntax:</span></p>
<p style="margin: 0px 0px 0px 48px;"><span class="f_Variables" style="font-weight: bold;">a := BowCutDefineTmpEnd (angleBE, 180 - angleBE, 0, 0, 0)</span></p>
<p style="margin: 0px 0px 0px 13px;"><span class="f_Variables" style="font-weight: bold;">&nbsp;</span></p>
<p style="margin: 0px 0px 0px 13px;"><img src="img/clip0004eng.jpg" width="603" height="282" border="0" alt="clip0004eng"></p>
<p class="p_Interligne"><span class="f_Interligne">&nbsp;</span></p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5"><tr valign="top"><td align="left">
<p>&nbsp;</p>
<p>Cette fonction facultative pr&#233;cise &#224; Winpro l'angle correspondant &#224; la fin de l'arc. </p>
<p>Cette fonction renvoie toujours <span class="f_Variables">1</span>.</p>
<p class="p_Interligne"><span class="f_Interligne">&nbsp;</span></p>
<p style="margin: 0px 0px 0px 24px;"><span style="text-decoration: underline;">Syntaxe:</span></p>
<p style="margin: 0px 0px 0px 48px;"><span class="f_Variables" style="font-weight: bold;">a := DecArcDefinirFin (angleBD, 180 - angleBF, 0, 0, 0)</span></p>
<p style="margin: 0px 0px 0px 13px;"><span class="f_Variables" style="font-weight: bold;">&nbsp;</span></p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5"><tr valign="top"><td align="left">
<p>&nbsp;</p>
<p>Deze optionele functie geeft aan Winpro de waarde van de hoek corresponderent aan het einde van de boog. </p>
...
<tr valign="top" align="left">
<td width="300" style="width: 300px; border: solid 1px #000000;"><p style="margin: 0px 0px 0px 13px;"><span style="font-weight: bold; text-decoration: underline;">Note:</span></p>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 14px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr valign="baseline"><td width="17"><span style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&#8226;</span></td><td>De 3 laatste parameters dienen steeds gezet te worden op <span class="f_Variables">0</span>.</p>
</td></tr></table></div></td>
</tr>
</table>
</div>
