  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        <p>Cet onglet permet de définir une correspondance entre la couleur de la coulisse de volet roulant et la couleur du dormant, lorsque la case "Suivre couleur dormant" est cochée dans l'onglet <span style="font-style: italic;"><a href="volcoulissecouleur.php">Couleurs</a></span> de la coulisse.</p>
        ...
        <p><span style="color: #ff0000;">Indisponible en cas de licences Volets Roulants Autonomes et également en cas de coulisse double.</span></p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Couleurs autorisées</span>: Liste des teintes autorisées pour cete coulisse. Sélectionnez ici une teinte à faire correspondre à une ou plusieurs teintes de dormant.</td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Couleurs dormant</span>: Liste les couleurs de dormant existantes. Sélectionnez ici une ou plusieurs teintes de dormant qui doivent correspondre à la teinte de coulisse choisie.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="top" align="left">
              ...
              style="width: 605px; height: 45px; border: solid 1px #000000;"><p
                ...
                <p style="margin: 0px 0px 0px 13px;"><span
                style="color: #000000;">Une configuration logique exclut la liaison de plusieurs teintes de coulisse pour une teinte de dormant. Soyez-y particulièrement attentif.</span></p>
              </td>
            </tr>
          </tbody>
        </table>
