...
var WinProHelpPageName=["Frame + fixed sash","Dormant + fixe"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?modulethdf.php"; }
else { parent.quicksync('a7.11.4'); }
//--></script>
  <script type="text/javascript" src="highlight.js">
  </script>
  <title>Frame + fixed sash</title>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="modulethdo.php">Previous</a>  <a
        href="ModuleThTO.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd">This dialog is similar to the frame + sash dialog, but for the outer frame only (fixed sash).</p>
      ...
      <p class="p_Textestd">See <a href="8_1_0_x.php">release note version 8.1</a> for more details.</p>
        ...
        <p class="p_Textestd">For every frame / reinforcement(s) combination, a thermic value should be set according 
		filling thickness.</p>
        ...
        src="img/clip0015dfeng.jpg" width="866" height="164" border="0"
        alt="clip0015dfeng"></p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      ...
      <p class="p_Textestd">Il faut renseigner le dormant et son renfort éventuel, ainsi que les 
	  ...
	  pour plus de détails.</p>
        ...
        dormant / renfort(s), il faudra définir une valeur thermique
        ...
        <p class="p_Textestd"
        style="text-align: center; margin: 0px 0px 0px 24px;"><img
        src="img/clip0015dffra.jpg" width="859" height="157" border="0"
        alt="clip0015dffra"></p>
