...
if(top.frames.length==0) { top.location.href="index.php?pandescription.php"; }
else { parent.quicksync('a5.9.1'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="panneaudecouper.php">Previous</a>  <a
        href="pandimensions.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
