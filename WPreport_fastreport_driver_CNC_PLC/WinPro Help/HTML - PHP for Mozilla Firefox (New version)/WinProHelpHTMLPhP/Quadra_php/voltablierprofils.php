...
if(top.frames.length==0) { top.location.href="index.php?voltablierprofils.htm"; }
else { parent.quicksync('a6.2.8'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        href="introduction.htm">Top</a>  <a
        href="voltabliervariables.php">Previous</a>  <a
        href="voltablierarticles.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p>This page allows you enumerating all the profiles that can be used to create
        ...
        src="img/clip0549eng.jpg" width="562" height="393" border="0"
        alt="clip0549eng"></p>
        ...
        colours allowed for this shutter curtain. If the
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd"
                style="font-weight: bold;">Bottom lath</span>:
                Check this box for the rule to be computed for the bottom lath only.</td>
            </tr>
          </tbody>
        </table>
        </div>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p>Cet onglet permet de définir les profils à consommer
        ...
        <p style="text-align: center;"><img src="img/clip0549fra.jpg"
        width="564" height="420" border="0" alt="clip0549fra"></p>
        ...
        liste des profils à consommer pour ce tablier. Sélectionner
        ...
        liste des couleurs autorisées pour ce tablier. Si le profil n'est
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Sous-lame</span>: Cochez cette case pour que la formule soit
                évaluée pour la sous-lame seulement.</td>
            </tr>
          </tbody>
        </table>
        </div>
