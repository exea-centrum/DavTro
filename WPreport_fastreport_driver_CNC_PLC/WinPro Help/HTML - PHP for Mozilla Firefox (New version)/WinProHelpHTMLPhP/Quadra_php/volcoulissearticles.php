...
if(top.frames.length==0) { top.location.href="index.php?volcoulissearticles.php"; }
else { parent.quicksync('a6.3.7'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcoulisseprofils.php">Previous</a>  <a
        href="volcoulissemo.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        this shutter rail. You have to give the rules for using each article. The
        ...
        src="img/clip0557eng.jpg" width="498" height="327" border="0"
        alt="clip0557eng"></p>
        ...
        section</span> contains the list of colours allowed for this shutter rail.</p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"></span>Cet onglet
        permet de définir les articles à consommer pour cette coulisse.</p>
        ...
        <p style="text-align: center;"><img src="img/clip0557.zoom89.gif"
        width="520" height="318" border="0" alt="clip0557"></p>
        ...
        liste des articles à consommer pour ce tablier. Sélectionner une
        ...
        liste des couleurs autorisées pour cette coulisse. Si
