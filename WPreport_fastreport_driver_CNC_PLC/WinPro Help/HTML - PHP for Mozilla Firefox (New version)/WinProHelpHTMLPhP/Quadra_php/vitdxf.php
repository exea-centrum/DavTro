...
if(top.frames.length==0)  { top.location.href="index.php?vitdxf.php"; }
else { parent.quicksync('a5.8.13'); }
//-->
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#FF8000">
  <tr valign="middle">
    ...
    <td align="right">
     ...
     <a href="vitdrawings.php">Previous</a>&nbsp;
     <a href="glazingsfilter.php">Next</a>
     </span>
    </td>
  </tr>
</table>
...
<p>This page lets you link automatically a cross-section drawing (see the page about <a href="dessindxf.php">DXF table</a>) to the glazing.
</p>
<p>&nbsp;</p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5"><tr valign="top"><td align="left">
<p><span style="font-size: 5pt;">&nbsp;</span></p>
<p>Cette page permet de lier automatiquement un dessin de coupe (voir la page sur les <a href="dessindxf.php">dessins DXF)</a> au vitrage.</p>
<p>&nbsp;</p>
<p style="text-align: center;"><img src="img/clip0195.jpg" width="474" height="286" border="0" alt="clip0195"></p>
