...
var WinProHelpPageName=["Price List","Tarif&nbsp"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?voltabliertarif.php"; }
else { parent.quicksync('a6.2.11'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="voltabliermo.php">Previous</a>  <a
        href="voltablierfiltres.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        lets you link one or more price table to each shutter curtain, depending on the
        colour.</span></p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        de lier une grille de prix à chaque tablier, en fonction de sa couleur.
        </span></p>
        ...
        class="f_Textestd">: Si le tablier peut être fabriqué dans plusieurs
