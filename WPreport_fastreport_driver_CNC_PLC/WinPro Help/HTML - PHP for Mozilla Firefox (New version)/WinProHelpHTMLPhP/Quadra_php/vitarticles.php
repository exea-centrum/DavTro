...
if(top.frames.length==0) { top.location.href="index.php?vitarticles.php"; }
else { parent.quicksync('a5.8.10'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="vitprofiles.php">Previous</a>  <a href="vitlabour.php">Next</a>
        </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p>This page is accessible only when the box <span style="font-weight: bold">Composed glass</span> 
	  is checked into the <a href="vitdescription.php">Description page</a>.</p>

        <p>This page allows you enumerating all the articles that can be used to create
        this glazing. You have to give the rules for using each article.</p>
        ...
        colours allowed into the <a href="vitdescription.php">Description</a> page. If the
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Number</span>: Number of the corresponding field in
                the composed code and description. Leave this field blank if
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Code</span>: Contains a small text that will
                replace the field #<span style="font-style: italic">n</span># (where <span style="font-style: italic">n</span> 
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p>Cet onglet permet de définir les articles à consommer
        pour ce vitrage composé, et n'est accessible que si la case <span
        ...
        liste des articles à consommer pour ce vitrage composé. Sélectionner
        ...
        href="vitdescription.php">Description</a>. Si l'article n'est pas
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Numéro</span>: Numéro du
                ...
                composer la description et/ou le code concaténé du vitrage
                composé.</td>
            </tr>
          </tbody>
        </table>
