...
if(top.frames.length==0) { top.location.href="index.php?pdcdrawings.php"; }
else { parent.quicksync('a5.14.7'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="pdcarticles.php">Previous</a>  <a
        href="pdcdxf.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
          ...
          <tbody>
            <tr valign="top" align="left">
              <td width="605"
                ...
                style="font-weight: bold;">Important</span>: If a drawing must not be drawn for any reason, use a 
				<span class="f_variables">Fail</span> instruction, with no message.</p>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <p style="text-align: center;"><img src="img/clip0217eng.jpg"
        width="633" height="359" border="0" alt="clip0217eng"></p>
        ...
        this list, and type the drawing code in the input field immediately on
        top of the list.</p>
        ...
        colours defined into the <a href="pdcdescription.php">Description</a> page of the decorative composed panel. If the
        drawing has no colour rule to follow, you simply need to select nothing from this list. 
		If the drawing (and its formula) only applies for
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        liste des dessins à utiliser pour ce panneau décoratif configuré. Sélectionner une
        ...
        liste des couleurs autorisées pour ce panneau décoratif configuré dans l'onglet <a
        href="pdcdescription.php">Description</a>. Si le dessin n'est pas
        ...
        <p class="p_Textestd"><span class="f_Textestd">Le bouton <span class="f_Textestd" style="font-weight: bold;">Inverser
        sélection</span> au-dessus de cette liste vous permet d'inverser la sélection dans la liste.</p>
