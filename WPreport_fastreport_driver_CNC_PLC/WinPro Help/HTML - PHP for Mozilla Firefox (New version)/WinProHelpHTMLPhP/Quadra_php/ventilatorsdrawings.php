  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        <p>Cet onglet permet de définir les dessins à utiliser pour dessiner cet
        aérateur.</p>
                  ...
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 
						'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
                      <td>Si un dessin ne doit pas être imprimés pour des raisons quelconques, utilisez 
					  une instruction <span class="f_Variables">Echec</span>, sans préciser de message.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
        ...
        liste des dessins à utiliser pour cet aérateur. Sélectionner une
        ...
        la formule de positionnement et mise à l'échelle du dessin, ainsi que quelques cases à cocher:</p>
