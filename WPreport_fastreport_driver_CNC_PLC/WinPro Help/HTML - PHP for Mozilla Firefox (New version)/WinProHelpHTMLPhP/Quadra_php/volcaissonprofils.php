...
if(top.frames.length==0) { top.location.href="index.php?volcaissonprofils.php"; }
else { parent.quicksync('a6.1.6'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcaissonvariables.php">Previous</a>  <a
        href="volcaissonarticles.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p>This page allows you enumerating all the profiles that can be used to create
        ...
        src="img/clip0543eng.jpg" width="751" height="379" border="0"
        alt="clip0543eng"></p>
        ...
        colours allowed for this shutter box. If the
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p>Cet onglet permet de définir les profils à consommer
        ...
        <p style="text-align: center; margin: 14px 0px 14px 0px;"><img src="img/clip0543fra.jpg"
        width="759" height="388" border="0" alt="clip0543fra"></p>
        ...
        liste des profils à consommer pour ce caisson. Sélectionner
        ...
        liste des couleurs autorisées pour ce caisson. Si le profil n'est
        ...
        <p style="background: #fffff2;"><span
        style="font-weight: bold; color: #000000; text-decoration: underline;">La zone de droite</span> contient la formule liée au
        profil, ainsi que différentes cases à cocher:</p>
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Caisson extérieur</span>:
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Flasque intérieur</span>:
          ...
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span class="f_Textestd"
                style="font-weight: bold;">Tablier (Couleur
