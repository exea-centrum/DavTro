...
if(top.frames.length==0) { top.location.href="index.php?volcaissonvariables.php"; }
else { parent.quicksync('a6.1.5'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcaissonquestions.php">Previous</a>  <a
        href="volcaissonprofils.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
...
<!-- Placeholder for topic body. -->
        ...
        variables to help you computing the roller shutter box components. They are listed
        below. </span></p>
          ...
          <tbody>
            ...
            <tr valign="top" align="left">
              ...
              <td width="558"
                ...
                style="margin: 0px 0px 0px 13px;">Total width of the roller shutter.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Total height of the roller shutter.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">ShutterWidth</span></p>
              </td>
              <td valign="middle" width="68" style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">PAL</span></p>
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Shutter width. In case of multiple curtains, this value represents 
				the total width of curtains (internal rails included) when specific components for the box are computed
				(box '<span style="font-weight: bold;">Shutter box</span>' checked);
                when computing specific components for final blade
				(box '<span style="font-weight: bold;">Curtain (final blade colour)</span>' checked), 
				this represents the width of considered curtain (rails and cleaances deduced).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Handling location, among values <span class="f_Variables">Left</span> or <span class="f_Variables">Right</span>.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">BoxHeight</span></p>
              </td>
              <td valign="middle" width="68" style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">PAL</span></p>
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Height of box only.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">ShutterCount</span></p>
              </td>
              <td valign="middle" width="68" style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">PAL</span></p>
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Number of curtains for this box.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="558"
                ...
                The leftmost or unique curtain is indexed as number 1, and is increased as necessary from left to right. 
				This variable is used when computing specific components for 'Curtain (Final blade colour)', meaning components for 
				each curtain that would be computed at box level (like axis parts).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">HandlingPosition</span></p>
              </td>
              <td valign="middle" width="68" style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-weight: bold;">PAL</span></p>
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Returns the handling position set into the order</p>

                <p style="margin: 0px 0px 0px 13px;"><img src="img/clip0541.gif"
                width="192" height="30" border="0" alt="clip0542"></p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">BoxLeftExtension</span></p>
              </td>
              <td valign="middle" width="68" style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-size: 13pt; font-family: 'Wingdings'; color: #ff0000;">&lArr;</span><span
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">This variable is designed to draw the extension profiles on the left end 
				of the shutter box, and should be set into the first profile page of the box.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">BoxRightExtension</span></p>
              </td>
              <td valign="middle" width="68" style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-size: 13pt; font-family: 'Wingdings'; color: #ff0000;">&lArr;</span><span
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">This variable is designed to draw the extension profiles on the right end 
				of the shutter box, and should be set into the first profile page of the box.</p>
              </td>
            </tr>
...
<!-- Placeholder for topic body. -->
        ...
        composants de vos caissons de volets roulants. En voici la liste.</p>
        ...
        style="background-color: #fff7ef; border: solid 3px #c0c0c0; border-spacing:0px; border-collapse: collapse;">
          <tbody>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Largeur totale du volet.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">LargeurTablier</span></p>
              </td>
              <td valign="middle" width="68"
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Largeur du tablier. Dans le
                cas d'un volet multiple, ceci représente la largeur totale des
                tabliers (coulisses intermédiaires comprises) lorsque l'on
                évalue les pièces spécifiques au caisson (case '<span
                style="font-weight: bold;">Caisson extérieur</span>' cochée);
                lorsque l'on évalue les pièces spécifiques à la sous-lame (case
                '<span style="font-weight: bold;">Tablier (couleur
                Sous-Lame)</span>' cochée), ceci représente la largeur du
                tablier considéré (coulisses et aisance déduites).</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Sens de manoeuvre saisi pour le caisson, valant <span class="f_Variables">Gauche</span> ou 
				<span class="f_Variables">Droite</span>.</p>
              </td>
            </tr>			
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Epaisseur d'une lame de
                tablier.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Nombre de lames dans le
                tablier.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">HauteurCaisson</span></p>
              </td>
              <td valign="middle" width="68"
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Hauteur du caisson.</p>
              </td>
            </tr>			
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">NombreTabliers</span></p>
              </td>
              <td valign="middle" width="68"
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Nombre de tabliers dans le
                caisson.</p>
              </td>
            </tr>			
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Numéro de tablier actuellement pris en
                ...
                numéro 1. Ce nombre croît vers la droite. Cette variable est
                utilisée lorsque le programme évalue les pièces spécifiques aux
                'Tablier (Couleur Sous-Lame)', c'est à dire en fait les pièces
                propres à chaque tablier et qui seraient définies dans le
                caisson (p.ex. les axes).</p>
              </td>
            </tr>			
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">Sortie</span></p>
              </td>
              <td valign="middle" width="68"
              style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Indique le type de sortie de manoeuvre. La
                valeur correspond au numéro fourni à l'encodage.</span></p>
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Largeur totale des profils d'élargissement
                sur la droite du châssis, si ces profils ne sont pas déduits de
                la largeur du châssis.</p>
              </td>
            </tr>			
            ...
            <tr valign="top" align="left">
              ...
              <td width="367"
                style="width: 367px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;">Cette variable vaut <span class="f_Variables">Vrai()</span> si le
                volet n'est pas couplé à un châssis.</p>
              </td>
            </tr>			
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">ExtensionGaucheCaisson</span></p>
              </td>
              <td valign="middle" width="68" style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-size: 13pt; font-family: 'Wingdings'; color: #ff0000;">&lArr;</span><span
              ...
              <td width="558"
                style="width: 558px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 13px;">Cette
                variable vous permet de dessiner les extensions de caisson pour
                l'extrêmité gauche. Elle doit être définie dans la 1ere formule
                de profil du caisson.</p>
              </td>
            </tr>
            ...
            <tr valign="top" align="left">
              ...
              style="width: 170px; border: solid 1px #c0c0c0;"><p
                style="margin: 0px 0px 0px 14px;"><span
                class="f_Variables">ExtensionDroiteCaisson</span></p>
              </td>
              <td valign="middle" width="68" style="width: 68px; border: solid 1px #c0c0c0;"><p
                style="text-align: center;"><span
                style="font-size: 13pt; font-family: 'Wingdings'; color: #ff0000;">&lArr;</span><span
              ...
              <td width="558"
                ...
                style="margin: 0px 0px 0px 13px;">Cette
                variable vous permet de dessiner les extensions de caisson pour
                l'extrêmité droite. Elle doit être définie dans la 1ere formule
                de profil du caisson.</p>
              </td>
            </tr>
