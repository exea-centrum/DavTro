...
if(top.frames.length==0) { top.location.href="index.php?ouvbaselabour.php"; }
else { parent.quicksync('a5.3.7'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="ouvcornerarticles.php">Previous</a>  <a
        href="ouvcornerlabour.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        this sash. You have to give the rules for using each operation. The
        operations will be examined by WinPro in the order in which they are
        defined, for each side of each leaf successively.</span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center; margin: 14px 0px 14px 0px;"><img
        src="img/clip0149eng.jpg" width="640" height="371" border="0"
        alt="clip0149eng"></p>
        ...
        section</span> contains the formula that applies to the labour, as well as some check boxes:</p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        d'énumérer les opérations relatives à chaque côté de l'ouvrant, et de
        donner les règles de calcul de chacune de ces opérations. Les
        opérations ainsi définies seront examinées une à une pour chaque côté
        de chaque vantail successivement, dans l'ordre de leur
        définition.</span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center;"><img src="img/clip0390.gif" width="460"
        height="300" border="0" alt="clip0390"></p>
        ...
        l'opération, ainsi que quelques cases à cocher:</span></p>
