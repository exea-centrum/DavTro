...
var WinProHelpPageName=["Door Bottom","Bas de Porte"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?modulethbasporte.php"; }
else { parent.quicksync('a7.11.8'); }
//--></script>
  <script type="text/javascript" src="highlight.js">
  </script>
  <title>Door Bottom</title>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="modulethbattement.php">Previous</a>  <a
        href="ConfigurationNiveauDates.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd">This dialog is similar to the sash / frame dialog, with replacing the outer frame by a 
	  sill and/or kaltefeind. 
	  See <a href="8_1_0_x.php">release note version 8.1</a> for more details.</p>

        <p class="p_Textestd">It also allows considering wether the profiles are reinforced or not (for PVC window), as well as 
		reinforcement nature as reinforcement has a big influence onto thermic performance of profiles.</p>

        <p class="p_Textestd">The reinforcement profile code sould be defined as a same profile may use different reinforcement profiles. 
		Values for profiles when not reinforced may also be set if required.</p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p class="p_Textestd">For every sill / sash / reinforcement(s) combination, a thermic value should be set according 
		filling thickness.</p>
        ...
        src="img/clip0015bpeng.jpg" width="1026" height="142" border="0"
        alt="clip0015bpeng"></p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Sill</span>: Code of the sill profile to consider for this profile 
			  combination.</td>
            </tr>
          </tbody>
        </table>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Kaltefeind</span>: Code of the <a href="modulethkalt.php">kaltefeind</a> 
			  profile to consider for this profile combination.</td>
            </tr>
          </tbody>
        </table>
        </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
	  ...
	  en remplaçant le dormant par un seuil et/ou un kaltefeind. Voir <a href="8_1_0_x.php">note de version 8.1</a> pour
        plus de détails.</p>
        ...
        seuil / ouvrant / renfort(s), il faudra définir une valeur thermique
        ...
        <p class="p_Textestd"
        style="text-align: center; margin: 0px 0px 0px 24px;"><img
        src="img/clip0015bpfra.jpg" width="1060" height="147" border="0"
        alt="clip0015bpfra"></p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Seuil</span>: Code du
                profil de seuil à considérer pour cette combinaison de
                profil.</td>
            </tr>
          </tbody>
        </table>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Kaltefeind</span>: Code du
                profil de <a href="modulethkalt.php">kaltefeind</a> à considérer pour cette combinaison de
                profil.</td>
            </tr>
          </tbody>
        </table>
