...
var WinProHelpPageName=["Labour","Main d'oeuvre&nbsp"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?volcaissonmo.php"; }
else { parent.quicksync('a6.1.8'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcaissonarticles.php">Previous</a>  <a
        href="volcaissontarif.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p> </p>
        ...
        src="img/clip0545eng.jpg" width="799" height="362" border="0"
        alt="clip0545eng"></p>
        ...
        section</span> contains the list of colours allowed for this box. If the
        ...
        section</span> contains the formula that applies to the labour, as
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p> </p>
        ...
        <p style="text-align: center;"><img src="img/clip0545fra.jpg"
        width="757" height="346" border="0" alt="clip0545fra"></p>
        ...
        liste des main d'oeuvres à consommer pour ce caisson. Sélectionner
        ...
        liste des couleurs autorisées pour ce caisson. Si la
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Visible de
                l'intérieur</span>: Cocher cette case si le composant est visible
          ...
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Visible de
                l'extérieur</span>: Cocher cette case si le composant est visible
        ...
        droite</span><span class="f_Textestd"> contient la formule liée à la
        </span>main d'oeuvre<span class="f_Textestd">, ainsi que différentes
        cases à cocher:</span></p>
