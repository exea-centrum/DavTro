...
var WinProHelpPageName=["Transom + sash","Traverse + ouvrant"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?modulethto.php"; }
else { parent.quicksync('a7.11.5'); }
//--></script>
  <script type="text/javascript" src="highlight.js">
  </script>
  <title>Transom + sash</title>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="modulethdf.php">Previous</a>  <a
        href="ModuleThtf.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd">This dialog is suitable to define the thermic values for couples of profiles sash / transom. 
	  See <a href="8_1_0_x.php">release note version 8.1</a> for more details.</p>
        ...
        <p class="p_Textestd">For every transom / sash / reinforcement(s) combination, a thermic value should be set according 
		filling thickness.</p>
        ...
        src="img/clip0015toeng.jpg" width="1027" height="182" border="0"
        alt="clip0015toeng"></p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd">Ce
        ...
        traverse. Voir <a href="8_1_0_x.php">note de version 8.1</a> pour
        plus de détails.</p>
        ...
        traverse / ouvrant / renfort(s), il faudra définir une valeur thermique
        ...
        <p class="p_Textestd"
        style="text-align: center; margin: 0px 0px 0px 24px;"><img
        src="img/clip0015tofra.jpg" width="1022" height="142" border="0"
        alt="clip0015tofra"></p>
