  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p> </p>
        ...
        <p>Cet onglet vous permet de définir les paramètres de la gestion de
        stock. Ces paramètres ne sont utilisés que si vous disposez du module
        de gestion prévisionnelle de stock.</p>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Minimum/maximum</span>: une
                ...
                nombre de lignes accessibles dépend du choix de la périodicité:
                mois, année, trimestre. Il n'est pas obligatoire de définir un
                stock maximum.</td>
            </tr>
          </tbody>
        </table>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Périodicité</span>:
                détermine comment gérer les stocks minimum et maximum.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Hors stock</span>: si cette
                case est cochée, la gestion de stock sera désactivée pour cet
                article.</td>
            </tr>
          </tbody>
        </table>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Stock actuel, réservations
                clients, commandes fournisseurs, disponible</span>: ces champs
                vous renseignent sur les quantités respectives en cours; vous
                pouvez cliquer sur le bouton Détail à côté de chaque champ pour
                obtenir le détail de ce total. Notez que l'onglet <a
                href="artprevision.php">Prévision</a> vous donne une vue plus
                précise sur les mouvements de stock futurs.</td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Coefficient
                multiplicateur</span>: coefficient par lequel les réservations
                de stock sont multipliées pour cet article. </td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="13"></td>
              <td>Si vous avez choisi de réserver le stock en optimisant les
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span style="font-weight: bold;">Coefficient de
                remplissage</span>: Représente l'occupation d'un article dans
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Catégorie</span>: Précise la
                catégorie (type) de casier dans lequel est stocké l'article.
                Les casiers sont créés via le menu Données - Autres données -
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="17"><span
                style="font-size: 10pt; font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
              <td><span style="font-weight: bold;">Magasin à
                décrémenter</span>: Lors de la mise en production, les
                mouvements de stock sont affectés à un emplacement par défaut,
                identique pour tous les articles. Vous pouvez définir ici, pour
                chaque article, un autre emplacement de stock à
              décrémenter.</td>
            </tr>
          </tbody>
        </table>
