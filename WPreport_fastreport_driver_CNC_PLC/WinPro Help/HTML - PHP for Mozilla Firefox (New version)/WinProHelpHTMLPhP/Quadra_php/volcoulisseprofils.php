...
if(top.frames.length==0) { top.location.href="index.php?volcoulisseprofils.php"; }
else { parent.quicksync('a6.3.6'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcoulissevariables.php">Previous</a>  <a
        href="volcoulissearticles.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p>This page allows you enumerating all the profiles that can be used to create
        ...
        src="img/clip0556eng.jpg" width="497" height="328" border="0"
        alt="clip0556eng"></p>
        ...
        colours allowed for this shutter rail. If the
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p>Cet onglet permet de définir les profils à consommer
        ...
        <p style="text-align: center;"><img src="img/clip0556.zoom108.gif"
        width="638" height="391" border="0" alt="clip0556"></p>
        ...
        liste des profils à consommer pour cette coulisse. Sélectionner
        ...
        liste des couleurs autorisées pour cette coulisse. Si le profil n'est
