...
if(top.frames.length==0) { top.location.href="index.php?rehlabour.php"; }
else { parent.quicksync('a5.5.6'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="reharticles.php">Previous</a>  <a
        href="rehpricelist.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        this peripheral profile or sill. You have to give the rules for using each operation. The
        operations will be examined by WinPro in the order in which they are
        defined. </span></p>

        <p style="text-align: center;"><img src="img/clip0251eng.jpg" width="634" height="360" border="0" alt="clip0251eng"></p>
        ...
        which the peripheral profile belongs to. If the operation has no colour rule to
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        d'énumérer les opérations relatives à chaque profil périphérique ou seuil, et de donner les
        règles de calcul de chacune de ces opérations. Les opérations ainsi
        définies seront examinées une à une pour chaque rehausse
        successivement, dans l'ordre de leur définition.</span></p>
        ...
        système auquel appartient la rehausse. </span></p>
