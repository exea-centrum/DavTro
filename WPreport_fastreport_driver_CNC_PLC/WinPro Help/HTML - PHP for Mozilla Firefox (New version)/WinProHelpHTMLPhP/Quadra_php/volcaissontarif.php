...
if(top.frames.length==0) { top.location.href="index.php?volcaissontarif.php"; }
else { parent.quicksync('a6.1.9'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="volcaissonmo.php">Previous</a>  <a
        href="volcaissonfiltres.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
		...
		total dimensions or masonry dimensions.</p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span
        ...
        de lier une grille de prix à chaque caisson, en fonction de sa
        couleur.</span></p>
        ...
        class="f_Textestd">: Si le caisson peut être fabriqué dans plusieurs
