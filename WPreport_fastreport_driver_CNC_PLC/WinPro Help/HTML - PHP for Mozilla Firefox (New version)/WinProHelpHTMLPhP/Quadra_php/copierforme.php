...
<table width="100%" border="0" cellspacing="0" cellpadding="5"><tr valign="top"><td align="left">
<p>&nbsp;</p>
<p>Cette fonction copie la forme dont l'index est source vers la forme dont l'index est destination. Si la forme source n'est pas définie, la forme destination ne le sera pas non plus. Si la forme destination existe déjà, elle sera remplacée par la forme source.</p>
