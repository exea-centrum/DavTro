...
var WinProHelpPageName=["Tarif","Tarif"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?pfabpricelist.php"; }
else { parent.quicksync('a5.11.10'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="pfabdrawings.php">Previous</a>  <a
        href="composedpanelsfilter.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        <p class="p_Textestd"><span class="f_Textestd">This page lets you link one or more price table to each panel, 
		depending on the colour.</span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center; margin: 14px 0px 0px 0px;"><img
        src="img/clip0219eng.jpg" width="685" height="389" border="0"
        alt="clip0219eng"></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Min. width</span>: The minimum width accepted for this panel.</p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Widths</span>: List of the widths in the price table. 
		The gap between 2 dimensions may be variable.</p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Generate</span>: This button lets you fill automatically the widths list, 
		with a constant increment:</p>
        ...
        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Min. height</span>: The minimum height
        accepted for this frame.</p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Heights</span>: List of the heights in the price 
		table. The gap between 2 dimensions may be variable.</p>
        ...
        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Colour groups</span>: If the panel can be made in different colours, 
		you may have to define more than one price table (one per colour group). Type an arbitrary number for each grid (from 0 to 99), 
        ...
        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Use for cost price</span>: Check this box if the price grid is 
		to be used when computing the cost price of the window.</p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Use for selling price</span>: Check this box if 
		the price grid is to be used when computing the selling price of the window.</p>

        <p class="p_Textestd"><span class="f_Textestd"
        style="font-weight: bold;">Input prices</span>: Click this button to select and fill the price tables. 
		When you click, you first get a list of the colour groups you have defined:</span></p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
        ...
        de lier une grille de prix à chaque panneau fabriqué, en fonction de sa
        couleur. </span></p>

        <p class="p_Textestd"><span class="f_Textestd"> </span></p>

        <p style="text-align: center; margin: 14px 0px 0px 0px;"><img
        src="img/clip0219fra.jpg" width="695" height="400" border="0"
        alt="clip0219fra"></p>
        ...
        class="f_Textestd">: Si le panneau peut être fabriqué dans plusieurs
        ...
        en côtes hors-tout, en fond de feuillure ouvrant ou en côtes tableau.</span></p>
