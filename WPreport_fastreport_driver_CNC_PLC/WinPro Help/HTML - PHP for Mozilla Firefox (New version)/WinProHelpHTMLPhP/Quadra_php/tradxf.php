...
if(top.frames.length==0) { top.location.href="index.php?tradxf.php"; }
else { parent.quicksync('a5.4.8'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="trapricelist.php">Previous</a>  <a
        href="transomsfilter.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span class="f_Textestd">This page
        lets you link automatically basic cross-section information for the
        transom.</span></p>

        <p style="text-align: center;"><img src="img/clip0172eng.jpg" width="336"
        height="153" border="0" alt="clip0172eng"></p>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd"
                style="font-weight: bold;">Profile</span><span
                style="color: #000000;">: Check this box to let the DXF linked
                to the profile (through the <a
                href="articles.php">article</a> definition) be automatically
                drawn. The profile must be defined as a 'Main profile' in the
                <a href="profils.php">profile</a> definition.</span></td>
            </tr>
          </tbody>
        </table>
        </div>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd"
                style="font-weight: bold;">Steel</span><span
                style="color: #000000;">: Check this box to let the DXF linked
                to the reinforcement (through the <a
                href="articles.php">article</a> definition) be automatically
                ...
                steel's drawing relatively to the main profile's drawing.</span></td>
            </tr>
          </tbody>
        </table>
        </div>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd"><span class="f_Textestd">Cet
        onglet vous permet de lier automatiquement à la traverse un certain
        nombre d'éléments de vues en coupe</span>.</p>

        <p style="text-align: center;"><img src="img/clip0172.jpg" width="336"
        height="153" border="0" alt="clip0172"></p>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd"
                ...
                profil principal dans la définition du <a href="profils.php">profil</a>.</span></td>
            </tr>
          </tbody>
        </table>
        </div>
          ...
          <tbody>
            <tr valign="baseline">
              ...
              <td><span class="f_Textestd"
                ...
                profil de renfort dans la définition du <a
                href="profils.php">profil</a>. Vous pouvez
