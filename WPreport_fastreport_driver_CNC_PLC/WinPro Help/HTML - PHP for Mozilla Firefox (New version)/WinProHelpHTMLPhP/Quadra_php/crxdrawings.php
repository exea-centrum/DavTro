...
if(top.frames.length==0) { top.location.href="index.php?crxdrawings.php"; }
else { parent.quicksync('a5.12.7'); }
//--></script>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        href="introduction.php">Top</a>  <a href="crxlabour.php">Previous</a> 
        <a href="glazingbarsfilter.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
                  ...
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 
						'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
                      <td>This page is enabled only if you have checked 'Use drawing formulas' in the 
					  <a href="crxdescription.php">Description</a> page.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
        ...
        <p style="text-align: center;"><img src="img/clip0202beng.jpg"
        width="560" height="359" border="0" alt="clip0202beng"></p>
  ...
  <tbody>
    <tr valign="top">
      <td align="left"><p><span style="font-size: 5pt;"> </span></p>
                  ...
                  <tbody>
                    <tr valign="baseline">
                      <td width="17"><span
                        style="font-size: 10pt; font-family: 'Arial Unicode MS', 
						'Lucida Sans Unicode', 'Arial'; color: #000000;">&bull;</span></td>
                      <td>Cette page n'est active que si la case 'Utiliser les
                        formules de dessins' est cochée dans la page <a
                        href="crxdescription.php">Description</a>.</td>
                    </tr>
                  </tbody>
                </table>
                </div>
        ...
        <p style="text-align: center;"><img src="img/clip0493.zoom90.gif"
        width="651" height="285" border="0" alt="clip0493"></p>
        ...
        liste des dessins à utiliser pour ce croisillon. Sélectionner une
        ...
        href="crxdescription.php">Description</a>. Si le dessin n'est pas
