...
var WinProHelpPageName=["Frame + sash","Dormant + ouvrant"];
WPlangInit(WinProHelpAvailableLanguages);
//Redirect browser to frame page if page is not in the content frame.
if(top.frames.length==0) { top.location.href="index.php?modulethdo.php"; }
else { parent.quicksync('a7.11.3'); }
//--></script>
  <script type="text/javascript" src="highlight.js">
  </script>
  <title>Frame + sash</title>
  ...
  <tbody>
    <tr valign="middle">
      ...
      <td align="right"><span style="font-size: 9pt"><a
        ...
        href="modulethkalt.php">Previous</a>  <a
        href="ModuleThDF.php">Next</a> </span> </td>
    </tr>
  </tbody>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd">This dialog is suitable to define the thermic values for couples of profiles sash / frame. 
	  See <a href="8_1_0_x.php">release note version 8.1</a> for more details.</p>
        ...
        <p class="p_Textestd">For every frame / sash / reinforcement(s) combination, a thermic value should be set according 
		filling thickness.</p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Outer frame</span>: Code of the outer frame profile to consider for this profile 
			  combination.</td>
            </tr>
          </tbody>
        </table>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Frame reinf.</span>: Code of the reinforcement profile for outer frame to consider for 
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
    <tr valign="top">
      <td align="left"><p class="p_Textestd">Ce
        dialogue permet de définir les valeurs thermiques des couples ouvrant /
        dormant. Voir <a href="8_1_0_x.php">note de version 8.1</a> pour
        plus de détails.</p>
        ...
        <p class="p_Textestd"
        style="text-align: center; margin: 0px 0px 0px 24px;"><img
        src="img/clip0015fra.jpg" width="1012" height="183" border="0"
        alt="clip0015fra"></p>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Dormant</span>: Code du
                profil de dormant à considérer pour cette combinaison de
                profil.</td>
            </tr>
          </tbody>
        </table>
        ...
        style="line-height: normal;">
          <tbody>
            <tr valign="baseline">
              <td width="24"><span
                style="font-family: 'Arial Unicode MS', 'Lucida Sans Unicode', 'Arial';">&bull;</span></td>
              <td><span style="font-weight: bold;">Renf. drm.</span>: Code du
                profil de renfort dormant à considérer pour cette combinaison
                de profil.</td>
            </tr>
          </tbody>
        </table>
