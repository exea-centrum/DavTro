SELECT     CDN.TwrKarty.Twr_Kod, CDN.TwrKarty.Twr_Jm AS JM, CDN.TraNag.TrN_TrNNumer, CDN.TraSElem.TrS_Ilosc AS Ilosc, 
                      ...
                      CASE CDN.TwrKarty.Twr_Typ WHEN 1 THEN 'T' WHEN 4 THEN 'U' ELSE 'inne' END AS typ, CDN.OpeKarty.Ope_Ident, CDN.TraNag.TrN_Data2, CDN.KntKarty.Knt_Akronim AS Dostawca
