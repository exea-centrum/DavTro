SELECT     CDN.TwrKarty.Twr_Kod, CDN.TwrKarty.Twr_Jm AS JM, CDN.TraNag.TrN_TrNNumer, CDN.TraSElem.TrS_Ilosc AS Ilosc, 
                      CDN.TraElem.TrE_KsiegowaNetto * CDN.TraSElem.TrS_Ilosc / CDN.TraElem.TrE_Ilosc AS WARTOSC, CDN.TraSElem.TrS_KosztKsiegowy, 
                      dbo.ktKosztDostawyDlaDanegoPZiGIDTowaru(CDN.Dostawy.Dst_TrnNumer, CDN.TraElem.TrE_TwrKod, CDN.Dostawy.Dst_SubTrnLp) * CDN.TraSElem.TrS_Ilosc AS koszt_dostawy, 
                      CDN.OpeKarty.Ope_Ident, CDN.TraNag.TrN_Data2, CDN.KntKarty.Knt_Akronim AS Dostawca
